    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember" id="remember"> <label class="uppercase text-gray-500 text-sm" for="remember">Recuerdame</label>
                </div>
                <input type="submit" value="Inicia sesion" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg" />
            </form>
        </div>
    </div>
@endsection